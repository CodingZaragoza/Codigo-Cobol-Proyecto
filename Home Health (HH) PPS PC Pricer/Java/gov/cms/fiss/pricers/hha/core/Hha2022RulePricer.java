...
public class Hha2022RulePricer extends HhaRulePricer {

  public Hha2022RulePricer(DataTables dataTables) {
  ...
  protected HhaPricerContext contextFor(HhaClaimPricingRequest input) {
    ...
    return new Hha2022PricerContext(input, output, dataTables);
  }
}
