...
public class Hha2023RulePricer extends HhaRulePricer {

  public Hha2023RulePricer(DataTables dataTables) {
  ...
  protected HhaPricerContext contextFor(HhaClaimPricingRequest input) {
    ...
    return new Hha2023PricerContext(input, output, dataTables);
  }
}
