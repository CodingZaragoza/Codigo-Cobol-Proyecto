...
import gov.cms.fiss.pricers.hha.core.rules.final_calculation.CalculateAddOnVisit2022;
...
public class Hha2024RulePricer extends HhaRulePricer {

  public Hha2024RulePricer(DataTables dataTables) {
  ...
  protected HhaPricerContext contextFor(HhaClaimPricingRequest input) {
    ...
    return new Hha2024PricerContext(input, output, dataTables);
  }
}
