...
public class HhaClaimPricingResource {
  final HhaPricerDispatch dispatch;

  public HhaClaimPricingResource(HhaPricerDispatch dispatch) {
  ...
  @Timed
  @Operation(
      summary = "Prices an HHA claim.",
      description =
          "Generates the pricing result for an HHA Claim. The result includes payment data, as "
        ...
        @ApiResponse(
            ...
            content =
                @Content(
                    ...
                    schema = @Schema(implementation = HhaClaimPricingResponse.class))),
        @ApiResponse(
            responseCode = "400",
            description =
  ...
  public HhaClaimPricingResponse priceClaim(
      @NotNull
          @Valid
          @Parameter(
              ...
              name = "pricingRequest",
              required = true,
              schema = @Schema(implementation = HhaClaimPricingRequest.class))
          HhaClaimPricingRequest pricingRequest)
