package gov.cms.fiss.pricers.fqhc.resources;
...
public class FqhcClaimPricingResource {
  private final FqhcPricerDispatch dispatch;

  public FqhcClaimPricingResource(FqhcPricerDispatch dispatch) {
  ...
  @Timed
  @Operation(
      summary = "Prices an FQHC claim.",
      description =
          "Generates the pricing result for an FQHC Claim. The result includes payment data, as "
        ...
        @ApiResponse(
            ...
            content =
                @Content(
                    ...
                    schema = @Schema(implementation = FqhcClaimPricingResponse.class))),
        @ApiResponse(
            responseCode = "400",
            description =
  ...
  public FqhcClaimPricingResponse priceClaim(
      @NotNull
          @Valid
          @Parameter(
              ...
              name = "pricingRequest",
              required = true,
              schema = @Schema(implementation = FqhcClaimPricingRequest.class))
          FqhcClaimPricingRequest pricingRequest)
