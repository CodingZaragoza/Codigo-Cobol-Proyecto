...
public class IppsClaimPricingResource {

  private final IppsPricerDispatch dispatch;

  public IppsClaimPricingResource(IppsPricerDispatch dispatch) {
  ...
  @Timed
  @Operation(
      summary = "Prices an IPPS claim.",
      description =
          "Generates the pricing result for an IPPS Claim. The result includes payment data, as "
        ...
        @ApiResponse(
            ...
            content =
                @Content(
                    ...
                    schema = @Schema(implementation = IppsClaimPricingResponse.class))),
        @ApiResponse(
            responseCode = "400",
            description =
  ...
  public IppsClaimPricingResponse priceClaim(
      @NotNull
          @Valid
          @Parameter(
              ...
              name = "pricingRequest",
              required = true,
              schema = @Schema(implementation = IppsClaimPricingRequest.class))
          IppsClaimPricingRequest pricingRequest)
