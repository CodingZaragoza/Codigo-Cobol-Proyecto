...
/**
 * Applies add-on costs for TriClip G4 if the technology was indicated in the claim.
 *
 * @since 2025
 */
public class CalculateTriclipAddOnCost extends CalculateTechnologyAddOnCost {

  private static final String TECHNOLOGY_NAME = "TRICLIP";
