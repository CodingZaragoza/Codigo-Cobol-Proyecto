...
/**
 * Applies add-on costs for Cosela if the technology was indicated in the claim.
 *
 * @since 2022
 */
public class CalculateCoselaAddOnCost extends CalculateTechnologyAddOnCost {

  private static final String TECHNOLOGY_NAME = "COSELA";
