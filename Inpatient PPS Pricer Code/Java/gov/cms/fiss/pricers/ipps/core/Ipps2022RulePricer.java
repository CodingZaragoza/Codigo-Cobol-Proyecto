...
import gov.cms.fiss.pricers.ipps.core.rules.calculate_payment.tech_addons.technology.nt2022.CalculateFetrojaAddOnCost2022;
...
import gov.cms.fiss.pricers.ipps.core.rules.calculate_payment.tech_addons.technology.nt2022.CalculateRecarbrioAddOnCost2022;
...
import gov.cms.fiss.pricers.ipps.core.rules.rules2022.assemble_variables.DetermineCovidAdjustment2022;
import gov.cms.fiss.pricers.ipps.core.rules.rules2022.assemble_variables.DetermineNewCovid19TreatmentsAddOnPayment2022;
...
/** Defines the processing flow for 2022 claims. */
public class Ipps2022RulePricer extends IppsRulePricer {

  /** Defines the rule set for processing claims for 2022. */
  private static final List<
          CalculationRule<IppsClaimPricingRequest, IppsClaimPricingResponse, IppsPricerContext>>
      YEAR_RULES = rules();

  public Ipps2022RulePricer(DataTables dataTables) {
            ...
            List.of(
                ...
                new DetermineCostsAndFactors(
                    List.of(
                        ...
                        new DetermineCovidAdjustment2022(),
                ...
                new DefaultPaymentCalculation(
                    List.of(
                            ...
                            List.of(
                                ...
                                new AddNewTechnologyCosts(
                                    List.of(
                                        ...
                                        new CalculateFetrojaAddOnCost2022(),
                                        ...
                                        new CalculateRecarbrioAddOnCost2022(),
                        ...
                        new DetermineNewCovid19TreatmentsAddOnPayment2022(),
  ...
  protected IppsPricerContext contextFor(IppsClaimPricingRequest input) {
    ...
    return new Ipps2022PricerContext(input, output, dataTables);
  }
}
