 ...
 * @since 2021
 */
public class CalculateRecarbrioAddOnCost2023 extends CalculateTechnologyAddOnCost {
    ...
    if (dataTables.codesMatch(
        ...
        || dataTables.codesMatch(
            ...
            && dataTables.codesMatch(
                ...
                ClaimCodeType.DIAG,
                calculationContext.getClaimData().getDiagnosisCodes())) {
      aggregateNewTechCost(calculationContext, dataTables.getNewTechnologyAmount("RECARBRIO"));
    }
  }
}
