 ...
 * @since 2019
 */
public class CalculateElectronicHealthRecordSavings
    implements CalculationRule<
        IppsClaimPricingRequest, IppsClaimPricingResponse, IppsPricerContext> {

  @Override
  public boolean shouldExecute(IppsPricerContext calculationContext) {
    //     IF P-EHR-REDUC-IND = 'Y'
    //         NEXT SENTENCE
    //     ELSE
    //         GO TO 9000-EXIT.
    return StringUtils.equals(calculationContext.getProviderData().getEhrReductionIndicator(), "Y");
  }
