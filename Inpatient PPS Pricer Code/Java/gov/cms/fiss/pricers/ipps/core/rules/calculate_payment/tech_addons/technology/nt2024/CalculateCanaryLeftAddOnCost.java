...
/**
 * Applies add-on costs for Canary Left if the technology was indicated in the claim.
 *
 * @since 2024
 */
public class CalculateCanaryLeftAddOnCost extends CalculateTechnologyAddOnCost {

  private static final String TECHNOLOGY_NAME = "CANARYLEFT";
