...
/**
 * Applies add-on costs for Cablivi if the technology was indicated in the claim.
 *
 * @since 2020
 */
public class CalculateCabliviAddOnCost extends CalculateTechnologyAddOnCost {

  private static final String TECHNOLOGY_NAME = "CABLIVI";

  @Override
  public void calculate(IppsPricerContext calculationContext) {
    //     IF PROC-CABLIVI-FLAG = 'Y'
