...
/**
 * Applies add-on costs for StrataGraft if the technology was indicated in the claim.
 *
 * @since 2022
 */
public class CalculateStrataGraftAddOnCost extends CalculateTechnologyAddOnCost {

  private static final String TECHNOLOGY_NAME = "STRATAGRAFT";
