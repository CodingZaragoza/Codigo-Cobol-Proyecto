...
/**
 * Applies add-on costs for Giapreza if the technology was indicated in the claim.
 *
 * @since 2019
 */
public class CalculateGiaprezaAddOnCost extends CalculateTechnologyAddOnCost {

  private static final String TECHNOLOGY_NAME = "GIAPREZA";

  @Override
  public void calculate(IppsPricerContext calculationContext) {
    //     IF PROC-GIAPREZA-FLAG = 'Y'
