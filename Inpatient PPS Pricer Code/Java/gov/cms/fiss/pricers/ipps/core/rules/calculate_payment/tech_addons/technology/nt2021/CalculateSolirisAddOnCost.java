...
/**
 * Applies add-on costs for Soliris if the technology was indicated in the claim.
 *
 * @since 2021
 */
public class CalculateSolirisAddOnCost extends CalculateTechnologyAddOnCost {

  private static final String TECHNOLOGY_NAME = "SOLIRIS";

  @Override
  public void calculate(IppsPricerContext calculationContext) {
    //     IF PROC-SOLIRIS-FLAG = 'Y'
