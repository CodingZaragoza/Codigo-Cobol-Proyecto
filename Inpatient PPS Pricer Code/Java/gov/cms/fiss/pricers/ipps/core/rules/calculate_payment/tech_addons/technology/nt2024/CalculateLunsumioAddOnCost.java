...
/**
 * Applies add-on costs for Lunsumio if the technology was indicated in the claim.
 *
 * @since 2024
 */
public class CalculateLunsumioAddOnCost extends CalculateTechnologyAddOnCost {

  private static final String TECHNOLOGY_NAME = "LUNSUMIO";
