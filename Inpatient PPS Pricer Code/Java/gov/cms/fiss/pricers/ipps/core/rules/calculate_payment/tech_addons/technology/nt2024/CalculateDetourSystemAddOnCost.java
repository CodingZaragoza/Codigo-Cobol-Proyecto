...
/**
 * Applies add-on costs for Detour System if the technology was indicated in the claim.
 *
 * @since 2024
 */
public class CalculateDetourSystemAddOnCost extends CalculateTechnologyAddOnCost {

  private static final String TECHNOLOGY_NAME = "DETOURSYSTEM";
