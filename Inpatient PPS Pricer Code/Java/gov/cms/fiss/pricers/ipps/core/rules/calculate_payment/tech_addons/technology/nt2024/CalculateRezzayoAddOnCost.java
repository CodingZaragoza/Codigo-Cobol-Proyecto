...
/**
 * Applies add-on costs for Rezzayo if the technology was indicated in the claim.
 *
 * @since 2024
 */
public class CalculateRezzayoAddOnCost extends CalculateTechnologyAddOnCost {

  private static final String TECHNOLOGY_NAME = "REZZAYO";
