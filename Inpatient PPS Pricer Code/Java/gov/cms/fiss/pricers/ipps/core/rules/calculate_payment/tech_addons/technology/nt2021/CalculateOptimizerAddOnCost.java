...
/**
 * Applies add-on costs for Optimizer if the technology was indicated in the claim.
 *
 * @since 2021
 */
public class CalculateOptimizerAddOnCost extends CalculateTechnologyAddOnCost {

  private static final String TECHNOLOGY_NAME = "OPTIMIZER";

  @Override
  public void calculate(IppsPricerContext calculationContext) {
    //     IF PROC-OPTIMIZER-FLAG = 'Y'
