...
/**
 * Applies add-on costs for Eluvia if the technology was indicated in the claim.
 *
 * @since 2021
 */
public class CalculateEluviaAddOnCost extends CalculateTechnologyAddOnCost {

  private static final String TECHNOLOGY_NAME = "ELUVIA";

  @Override
  public void calculate(IppsPricerContext calculationContext) {
    //     IF PROC-ELUVIA-FLAG = 'Y'
