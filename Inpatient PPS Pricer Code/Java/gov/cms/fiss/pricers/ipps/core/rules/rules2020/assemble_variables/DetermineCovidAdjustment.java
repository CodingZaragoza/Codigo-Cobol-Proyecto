package gov.cms.fiss.pricers.ipps.core.rules.rules2020.assemble_variables;
 ...
 * @since 2020
 */
public class DetermineCovidAdjustment
  ...
  public void calculate(IppsPricerContext calculationContext) {
    ...
    //
    //     IF (B-DISCHARGE-DATE > 20200126 AND
    //        B-DISCHARGE-DATE < 20200401)
    //        IF DIAG-COVID1-FLAG = 'Y'
    //           MOVE 1.2 TO COVID-ADJ.

    // A factor of 1.2 is effective as of 01/27/2020
    if (dataTables.codesMatch(
                IppsPricerContext.CODE_COVID1, ClaimCodeType.DIAG, claimData.getDiagnosisCodes())
        ...
        || dataTables.codesMatch(
            ...
            && LocalDateUtils.isAfterOrEqual(
                calculationContext.getDischargeDate(), LocalDate.of(2020, 4, 1))) {
