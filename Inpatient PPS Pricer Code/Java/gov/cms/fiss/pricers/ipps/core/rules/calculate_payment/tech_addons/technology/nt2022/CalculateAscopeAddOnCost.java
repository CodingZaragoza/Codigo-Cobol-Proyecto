...
/**
 * Applies add-on costs for Ascope if the technology was indicated in the claim.
 *
 * @since 2022
 */
public class CalculateAscopeAddOnCost extends CalculateTechnologyAddOnCost {

  private static final String TECHNOLOGY_NAME = "ASCOPE";
