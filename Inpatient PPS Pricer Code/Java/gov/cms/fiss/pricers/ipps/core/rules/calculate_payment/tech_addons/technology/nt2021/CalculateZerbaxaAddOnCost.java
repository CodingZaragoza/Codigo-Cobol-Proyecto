...
/**
 * Applies add-on costs for Zerbaxa if the technology was indicated in the claim.
 *
 * @since 2021
 */
public class CalculateZerbaxaAddOnCost extends CalculateTechnologyAddOnCost {

  private static final String TECHNOLOGY_NAME = "ZERBAXA";
