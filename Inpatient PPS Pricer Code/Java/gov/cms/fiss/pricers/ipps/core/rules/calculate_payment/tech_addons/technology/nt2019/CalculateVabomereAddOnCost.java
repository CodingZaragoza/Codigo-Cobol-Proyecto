...
/**
 * Applies add-on costs for Vabomere if the technology was indicated in the claim.
 *
 * @since 2019
 */
public class CalculateVabomereAddOnCost extends CalculateTechnologyAddOnCost {

  private static final String TECHNOLOGY_NAME = "VABOMERE";

  @Override
  public void calculate(IppsPricerContext calculationContext) {
    //     IF NDC-VABOMERE-FLAG = 'Y'
    ...
    if (dataTables.codesMatch(
            TECHNOLOGY_NAME, ClaimCodeType.NDC, calculationContext.getProvidedNationalDrugCodes())
