...
/**
 * Applies add-on costs for Caption Guidance if the technology was indicated in the claim.
 *
 * @since 2022
 */
public class CalculateCaptionGuidanceAddOnCost extends CalculateTechnologyAddOnCost {

  private static final String TECHNOLOGY_NAME = "CAPTIONGUIDANCE";
