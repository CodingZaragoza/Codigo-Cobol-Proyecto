...
/**
 * Applies add-on costs for Veklury if the technology was indicated in the claim.
 *
 * @since 2022
 */
public class CalculateVekluryAddOnCost extends CalculateTechnologyAddOnCost {

  private static final String TECHNOLOGY_NAME = "VEKLURY";
