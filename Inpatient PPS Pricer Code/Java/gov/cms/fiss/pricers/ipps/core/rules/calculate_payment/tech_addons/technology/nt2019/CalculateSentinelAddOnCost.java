...
/**
 * Applies add-on costs for Sentinel if the technology was indicated in the claim.
 *
 * @since 2019
 */
public class CalculateSentinelAddOnCost extends CalculateTechnologyAddOnCost {

  private static final String TECHNOLOGY_NAME = "SENTINEL";

  @Override
  public void calculate(IppsPricerContext calculationContext) {
    //     IF PROC-SENTINEL-FLAG = 'Y'
