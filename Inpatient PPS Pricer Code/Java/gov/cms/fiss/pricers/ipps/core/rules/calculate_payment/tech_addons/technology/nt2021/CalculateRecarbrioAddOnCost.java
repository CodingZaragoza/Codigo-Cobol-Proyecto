 ...
 * @since 2021
 */
public class CalculateRecarbrioAddOnCost extends CalculateTechnologyAddOnCost {

  private static final String TECHNOLOGY_NAME = "RECARBRIO";

  @Override
  public void calculate(IppsPricerContext calculationContext) {
    //     IF PROC-RECARBIO-FLAG = 'Y'
