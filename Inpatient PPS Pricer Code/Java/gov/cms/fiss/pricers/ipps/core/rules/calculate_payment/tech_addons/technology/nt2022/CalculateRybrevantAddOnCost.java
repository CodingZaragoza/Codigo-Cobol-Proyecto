...
/**
 * Applies add-on costs for Rybrevant if the technology was indicated in the claim.
 *
 * @since 2022
 */
public class CalculateRybrevantAddOnCost extends CalculateTechnologyAddOnCost {

  private static final String TECHNOLOGY_NAME = "RYBREVANT";
