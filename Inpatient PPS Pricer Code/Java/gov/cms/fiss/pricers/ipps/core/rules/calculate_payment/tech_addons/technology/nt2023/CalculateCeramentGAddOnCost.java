...
/**
 * Applies add-on costs for CeramentG if the technology was indicated in the claim.
 *
 * @since 2023
 */
public class CalculateCeramentGAddOnCost extends CalculateTechnologyAddOnCost {

  private static final String TECHNOLOGY_NAME = "CERAMENTG";
