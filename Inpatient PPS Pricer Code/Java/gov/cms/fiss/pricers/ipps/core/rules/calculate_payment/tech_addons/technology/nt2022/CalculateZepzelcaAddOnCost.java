...
/**
 * Applies add-on costs for Zepzelca if the technology was indicated in the claim.
 *
 * @since 2022
 */
public class CalculateZepzelcaAddOnCost extends CalculateTechnologyAddOnCost {

  private static final String TECHNOLOGY_NAME = "ZEPZELCA";
