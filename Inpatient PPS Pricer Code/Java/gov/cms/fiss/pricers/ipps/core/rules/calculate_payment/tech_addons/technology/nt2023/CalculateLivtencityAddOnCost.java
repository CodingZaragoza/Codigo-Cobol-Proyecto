...
/**
 * Applies add-on costs for Livtencity if the technology was indicated in the claim.
 *
 * @since 2023
 */
public class CalculateLivtencityAddOnCost extends CalculateTechnologyAddOnCost {

  private static final String TECHNOLOGY_NAME = "LIVTENCITY";
