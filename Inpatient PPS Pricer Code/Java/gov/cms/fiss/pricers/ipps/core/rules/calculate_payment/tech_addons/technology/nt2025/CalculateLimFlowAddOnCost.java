...
/**
 * Applies add-on costs for LimFlow System if the technology was indicated in the claim.
 *
 * @since 2025
 */
public class CalculateLimFlowAddOnCost extends CalculateTechnologyAddOnCost {

  private static final String TECHNOLOGY_NAME = "LIMFLOW";
