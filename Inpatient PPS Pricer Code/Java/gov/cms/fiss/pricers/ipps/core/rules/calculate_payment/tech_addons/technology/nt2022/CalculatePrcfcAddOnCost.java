...
/**
 * Applies add-on costs for PRCFC if the technology was indicated in the claim.
 *
 * @since 2022
 */
public class CalculatePrcfcAddOnCost extends CalculateTechnologyAddOnCost {

  private static final String TECHNOLOGY_NAME = "PRCFC";
