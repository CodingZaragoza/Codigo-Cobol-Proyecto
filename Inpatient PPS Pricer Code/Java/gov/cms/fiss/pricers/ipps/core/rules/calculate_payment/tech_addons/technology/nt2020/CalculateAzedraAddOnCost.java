...
/**
 * Applies add-on costs for Azedra if the technology was indicated in the claim.
 *
 * @since 2020
 */
public class CalculateAzedraAddOnCost extends CalculateTechnologyAddOnCost {

  private static final String TECHNOLOGY_NAME = "AZEDRA";

  @Override
  public void calculate(IppsPricerContext calculationContext) {
    //     IF PROC-AZEDRA-FLAG = 'Y'
