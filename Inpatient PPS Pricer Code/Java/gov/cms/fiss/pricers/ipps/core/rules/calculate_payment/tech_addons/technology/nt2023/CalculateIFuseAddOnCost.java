...
/**
 * Applies add-on costs for iFuse if the technology was indicated in the claim.
 *
 * @since 2023
 */
public class CalculateIFuseAddOnCost extends CalculateTechnologyAddOnCost {

  private static final String TECHNOLOGY_NAME = "IFUSE";
