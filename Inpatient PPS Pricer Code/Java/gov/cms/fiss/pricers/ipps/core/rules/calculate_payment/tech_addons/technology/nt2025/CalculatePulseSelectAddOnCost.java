...
/**
 * Applies add-on costs for PulseSelect if the technology was indicated in the claim.
 *
 * @since 2025
 */
public class CalculatePulseSelectAddOnCost extends CalculateTechnologyAddOnCost {

  private static final String TECHNOLOGY_NAME = "PULSESELECT";
