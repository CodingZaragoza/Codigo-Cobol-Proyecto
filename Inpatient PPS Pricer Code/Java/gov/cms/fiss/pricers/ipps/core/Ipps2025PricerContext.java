...
public class Ipps2025PricerContext extends IppsPricerContext {
  public static final String CALCULATION_VERSION = "2025.1";

  // Per-Year constants
  private static final BigDecimal CAPITAL_BASE_RATE_2025 = new BigDecimal("512.14");
  private static final BigDecimal OPERATING_BASE_RATE_2025 = new BigDecimal("6624.39");
  private static final BigDecimal MIDNIGHT_ADJUSTMENT_FACTOR_2025 = new BigDecimal("1.0");
  private static final BigDecimal COST_THRESHOLD_BASE_2025 = new BigDecimal("46217.00");
  private static final BigDecimal LABOR_PCT_WI_GT_ONE_2025 = new BigDecimal("0.676");
  private static final BigDecimal NON_LABOR_PCT_WI_GT_ONE_2025 = new BigDecimal("0.324");
  private static final BigDecimal LABOR_PCT_WI_LTEQ_ONE_2025 = new BigDecimal("0.62");
  private static final BigDecimal NON_LABOR_PCT_WI_LTEQ_ONE_2025 = new BigDecimal("0.38");
  private static final BigDecimal NO_COST_PRODUCT_ADJUSTMENT_FACTOR_2025 = new BigDecimal("0.33");
  private static final BigDecimal MARKET_BASKET_RATIO_EHR_FULL_2025 = new BigDecimal("1.025411061");
  private static final BigDecimal MARKET_BASKET_RATIO_EHR_QUALIFIED_FULL_2025 =
      new BigDecimal("1.025628141");
  private static final BigDecimal MARKET_BASKET_RATIO_EHR_FULL_PR_2025 =
      new BigDecimal("1.025411061");
  ...
  private static final BigDecimal OPER_HSP_BUDGET_NEUTRAL_BASE_2025_1 =
      new BigDecimal("0.997190").setScale(6, RoundingMode.HALF_UP);
  private static final BigDecimal OPER_HSP_BUDGET_NEUTRAL_BASE_2025_2 =
      new BigDecimal("0.999874").setScale(6, RoundingMode.HALF_UP);
  ...
  private static final BigDecimal OPER_HSP_UPDATE_2021 =
      new BigDecimal("1.0240").setScale(6, RoundingMode.HALF_UP);
  private static final BigDecimal OPER_HSP_UPDATE_2022 =
      new BigDecimal("1.0200").setScale(6, RoundingMode.HALF_UP);
  private static final BigDecimal OPER_HSP_UPDATE_2023 =
      new BigDecimal("1.0380").setScale(6, RoundingMode.HALF_UP);
  private static final BigDecimal OPER_HSP_UPDATE_2024 =
      new BigDecimal("1.0310").setScale(6, RoundingMode.HALF_UP);
  private static final BigDecimal OPER_HSP_UPDATE_NO_QUALITY_EHR_2025 =
      new BigDecimal("0.9950").setScale(6, RoundingMode.HALF_UP);
  private static final BigDecimal OPER_HSP_UPDATE_NO_QUALITY_NO_EHR_2025 =
      new BigDecimal("1.0205").setScale(6, RoundingMode.HALF_UP);
  private static final BigDecimal OPER_HSP_UPDATE_QUALITY_EHR_2025 =
      new BigDecimal("1.0035").setScale(6, RoundingMode.HALF_UP);
  private static final BigDecimal OPER_HSP_UPDATE_QUALITY_NO_EHR_2025 =
      new BigDecimal("1.0290").setScale(6, RoundingMode.HALF_UP);
  private static final BigDecimal OPER_HSP_UPDATE_NO_EHR_PR_2025 =
      new BigDecimal("1.0290").setScale(6, RoundingMode.HALF_UP);
  private static final BigDecimal OPER_HSP_UPDATE_EHR_PR_2025 =
      new BigDecimal("1.0035").setScale(6, RoundingMode.HALF_UP);

  public Ipps2025PricerContext(
  ...
  public BigDecimal getBudgetNeutralBase() {
    return OPER_HSP_BUDGET_NEUTRAL_BASE_2019
        ...
        .multiply(OPER_HSP_BUDGET_NEUTRAL_BASE_2025_1)
        .multiply(OPER_HSP_BUDGET_NEUTRAL_BASE_2025_2);
  }
