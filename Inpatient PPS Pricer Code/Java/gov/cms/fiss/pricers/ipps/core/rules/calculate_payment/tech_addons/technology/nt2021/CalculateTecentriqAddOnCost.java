...
/**
 * Applies add-on costs for Tecentriq if the technology was indicated in the claim.
 *
 * @since 2021
 */
public class CalculateTecentriqAddOnCost extends CalculateTechnologyAddOnCost {

  private static final String TECHNOLOGY_NAME = "TECENTRIQ";
