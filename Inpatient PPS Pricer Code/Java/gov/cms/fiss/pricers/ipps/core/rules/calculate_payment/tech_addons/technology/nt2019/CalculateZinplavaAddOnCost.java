...
/**
 * Applies add-on costs for Zinplava if the technology was indicated in the claim.
 *
 * @since 2019
 */
public class CalculateZinplavaAddOnCost extends CalculateTechnologyAddOnCost {

  private static final String TECHNOLOGY_NAME = "ZINPLAVA";
