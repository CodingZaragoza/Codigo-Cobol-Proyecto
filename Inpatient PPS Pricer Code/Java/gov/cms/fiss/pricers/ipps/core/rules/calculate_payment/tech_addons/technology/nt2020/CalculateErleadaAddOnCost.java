...
/**
 * Applies add-on costs for Erleada if the technology was indicated in the claim.
 *
 * @since 2020
 */
public class CalculateErleadaAddOnCost extends CalculateTechnologyAddOnCost {

  private static final String TECHNOLOGY_NAME = "ERLEADA";

  @Override
  public void calculate(IppsPricerContext calculationContext) {
    //     IF PROC-ERLEADA-FLAG = 'Y'
