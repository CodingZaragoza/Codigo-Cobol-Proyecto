...
/**
 * Applies add-on costs for CASGEVY if the technology was indicated in the claim.
 *
 * @since 2025
 */
public class CalculateCasgevyAddOnCost extends CalculateTechnologyAddOnCost {

  private static final String TECHNOLOGY_NAME = "CASGEVY";
