...
/**
 * Applies add-on costs for Aquabeam if the technology was indicated in the claim.
 *
 * @since 2019
 */
public class CalculateAquabeamAddOnCost extends CalculateTechnologyAddOnCost {

  private static final String TECHNOLOGY_NAME = "AQUABEAM";

  @Override
  public void calculate(IppsPricerContext calculationContext) {
    //     IF PROC-AQUABEAM-FLAG = 'Y'
