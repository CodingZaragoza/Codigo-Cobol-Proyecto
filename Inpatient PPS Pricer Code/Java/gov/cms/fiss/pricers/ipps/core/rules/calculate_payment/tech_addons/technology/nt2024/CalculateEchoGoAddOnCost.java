...
/**
 * Applies add-on costs for Echo Go if the technology was indicated in the claim.
 *
 * @since 2024
 */
public class CalculateEchoGoAddOnCost extends CalculateTechnologyAddOnCost {

  private static final String TECHNOLOGY_NAME = "ECHOGO";
