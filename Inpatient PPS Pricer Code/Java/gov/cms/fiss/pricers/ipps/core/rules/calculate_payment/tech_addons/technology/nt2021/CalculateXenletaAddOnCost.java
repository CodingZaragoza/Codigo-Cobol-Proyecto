...
/**
 * Applies add-on costs for Xenleta if the technology was indicated in the claim.
 *
 * @since 2021
 */
public class CalculateXenletaAddOnCost extends CalculateTechnologyAddOnCost {

  private static final String TECHNOLOGY_NAME = "XENLETA";
