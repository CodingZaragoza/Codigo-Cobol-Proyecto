...
/**
 * Applies add-on costs for Aprevo if the technology was indicated in the claim.
 *
 * @since 2022
 */
public class CalculateAprevoAddOnCost extends CalculateTechnologyAddOnCost {

  private static final String TECHNOLOGY_NAME = "APREVO";
