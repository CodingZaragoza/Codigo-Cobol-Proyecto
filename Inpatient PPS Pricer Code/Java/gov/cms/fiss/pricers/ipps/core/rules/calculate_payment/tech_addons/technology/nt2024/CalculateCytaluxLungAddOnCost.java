...
/**
 * Applies add-on costs for Cytalux Lung if the technology was indicated in the claim.
 *
 * @since 2024
 */
public class CalculateCytaluxLungAddOnCost extends CalculateTechnologyAddOnCost {

  private static final String TECHNOLOGY_NAME = "CYTALUXLUNG";
