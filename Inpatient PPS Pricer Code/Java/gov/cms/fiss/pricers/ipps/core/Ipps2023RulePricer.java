...
import gov.cms.fiss.pricers.ipps.core.rules.calculate_payment.tech_addons.technology.nt2022.CalculateAbecmaAddOnCost;
import gov.cms.fiss.pricers.ipps.core.rules.calculate_payment.tech_addons.technology.nt2022.CalculateAprevoAddOnCost;
import gov.cms.fiss.pricers.ipps.core.rules.calculate_payment.tech_addons.technology.nt2022.CalculateAscopeAddOnCost;
import gov.cms.fiss.pricers.ipps.core.rules.calculate_payment.tech_addons.technology.nt2022.CalculateCaptionGuidanceAddOnCost;
import gov.cms.fiss.pricers.ipps.core.rules.calculate_payment.tech_addons.technology.nt2022.CalculateCoselaAddOnCost;
import gov.cms.fiss.pricers.ipps.core.rules.calculate_payment.tech_addons.technology.nt2022.CalculateHarmonyAddOnCost;
import gov.cms.fiss.pricers.ipps.core.rules.calculate_payment.tech_addons.technology.nt2022.CalculatePrcfcAddOnCost;
import gov.cms.fiss.pricers.ipps.core.rules.calculate_payment.tech_addons.technology.nt2022.CalculateRybrevantAddOnCost;
import gov.cms.fiss.pricers.ipps.core.rules.calculate_payment.tech_addons.technology.nt2022.CalculateShockwaveAddOnCost;
import gov.cms.fiss.pricers.ipps.core.rules.calculate_payment.tech_addons.technology.nt2022.CalculateStrataGraftAddOnCost;
import gov.cms.fiss.pricers.ipps.core.rules.calculate_payment.tech_addons.technology.nt2022.CalculateTecartusAddOnCost;
import gov.cms.fiss.pricers.ipps.core.rules.calculate_payment.tech_addons.technology.nt2022.CalculateVekluryAddOnCost;
import gov.cms.fiss.pricers.ipps.core.rules.calculate_payment.tech_addons.technology.nt2022.CalculateZepzelcaAddOnCost;
import gov.cms.fiss.pricers.ipps.core.rules.calculate_payment.tech_addons.technology.nt2023.CalculateCeramentGAddOnCost;
import gov.cms.fiss.pricers.ipps.core.rules.calculate_payment.tech_addons.technology.nt2023.CalculateDarzalexAddOnCost;
import gov.cms.fiss.pricers.ipps.core.rules.calculate_payment.tech_addons.technology.nt2023.CalculateFetrojaAddOnCost2023;
import gov.cms.fiss.pricers.ipps.core.rules.calculate_payment.tech_addons.technology.nt2023.CalculateGoreTagAddOnCost;
import gov.cms.fiss.pricers.ipps.core.rules.calculate_payment.tech_addons.technology.nt2023.CalculateHemolungAddOnCost;
import gov.cms.fiss.pricers.ipps.core.rules.calculate_payment.tech_addons.technology.nt2023.CalculateIFuseAddOnCost;
import gov.cms.fiss.pricers.ipps.core.rules.calculate_payment.tech_addons.technology.nt2023.CalculateLivtencityAddOnCost;
import gov.cms.fiss.pricers.ipps.core.rules.calculate_payment.tech_addons.technology.nt2023.CalculateRecarbrioAddOnCost2023;
...
import gov.cms.fiss.pricers.ipps.core.rules.rules2023.assemble_variables.DetermineCovidAdjustment2023;
import gov.cms.fiss.pricers.ipps.core.rules.rules2023.assemble_variables.DetermineNewCovid19TreatmentsAddOnPayment2023;
...
/** Defines the processing flow for 2023 claims. */
public class Ipps2023RulePricer extends IppsRulePricer {

  /** Defines the rule set for processing claims for 2023. */
  private static final List<
          CalculationRule<IppsClaimPricingRequest, IppsClaimPricingResponse, IppsPricerContext>>
      YEAR_RULES = rules();

  public Ipps2023RulePricer(DataTables dataTables) {
            ...
            List.of(
                ...
                new DetermineCostsAndFactors(
                    List.of(
                        ...
                        new DetermineCovidAdjustment2023(),
                ...
                new DefaultPaymentCalculation(
                    List.of(
                        ...
                        new CalculateTechAddOns(
                            List.of(
                                ...
                                new AddNewTechnologyCosts(
                                    List.of(
                                        new CalculateAbecmaAddOnCost(),
                                        new CalculateAprevoAddOnCost(),
                                        new CalculateAscopeAddOnCost(),
                                        new CalculateCaptionGuidanceAddOnCost(),
                                        new CalculateCeramentGAddOnCost(),
                                        new CalculateCoselaAddOnCost(),
                                        new CalculateDarzalexAddOnCost(),
                                        new CalculateFetrojaAddOnCost2023(),
                                        new CalculateGoreTagAddOnCost(),
                                        new CalculateHarmonyAddOnCost(),
                                        new CalculateHemolungAddOnCost(),
                                        new CalculateIFuseAddOnCost(),
                                        new CalculateLivtencityAddOnCost(),
                                        new CalculatePrcfcAddOnCost(),
                                        new CalculateRecarbrioAddOnCost2023(),
                                        new CalculateRybrevantAddOnCost(),
                                        new CalculateShockwaveAddOnCost(),
                                        new CalculateStrataGraftAddOnCost(),
                                        new CalculateTecartusAddOnCost(),
                                        new CalculateThoraflexAddOnCost(),
                                        new CalculateVekluryAddOnCost(),
                                        new CalculateViviStimAddOnCost(),
                                        new CalculateZepzelcaAddOnCost())),
                        ...
                        new DetermineNewCovid19TreatmentsAddOnPayment2023(),
  ...
  protected IppsPricerContext contextFor(IppsClaimPricingRequest input) {
    ...
    return new Ipps2023PricerContext(input, output, dataTables);
  }
}
