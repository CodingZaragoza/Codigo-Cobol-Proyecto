...
/**
 * Applies add-on costs for Tecartus if the technology was indicated in the claim.
 *
 * @since 2022
 */
public class CalculateTecartusAddOnCost extends CalculateTechnologyAddOnCost {

  private static final String TECHNOLOGY_NAME = "TECARTUS";
