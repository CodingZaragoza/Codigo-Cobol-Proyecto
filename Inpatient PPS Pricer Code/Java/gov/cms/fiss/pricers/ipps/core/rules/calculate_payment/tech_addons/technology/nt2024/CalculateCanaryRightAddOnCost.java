...
/**
 * Applies add-on costs for Canary Right if the technology was indicated in the claim.
 *
 * @since 2024
 */
public class CalculateCanaryRightAddOnCost extends CalculateTechnologyAddOnCost {

  private static final String TECHNOLOGY_NAME = "CANARYRIGHT";
