...
/**
 * Applies add-on costs for Saint Neuromod if the technology was indicated in the claim.
 *
 * @since 2024
 */
public class CalculateSaintNeuromodAddOnCost extends CalculateTechnologyAddOnCost {

  private static final String TECHNOLOGY_NAME = "SAINTNEUROMOD";
