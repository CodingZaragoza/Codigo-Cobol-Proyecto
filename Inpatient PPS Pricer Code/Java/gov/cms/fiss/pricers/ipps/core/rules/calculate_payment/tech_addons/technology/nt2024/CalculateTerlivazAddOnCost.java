...
/**
 * Applies add-on costs for Terlivaz if the technology was indicated in the claim.
 *
 * @since 2024
 */
public class CalculateTerlivazAddOnCost extends CalculateTechnologyAddOnCost {

  private static final String TECHNOLOGY_NAME = "TERLIVAZ";
