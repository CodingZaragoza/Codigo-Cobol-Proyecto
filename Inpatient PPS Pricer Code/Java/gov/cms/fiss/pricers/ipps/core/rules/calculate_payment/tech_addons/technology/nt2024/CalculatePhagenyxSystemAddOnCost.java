...
/**
 * Applies add-on costs for Phagenyx System if the technology was indicated in the claim.
 *
 * @since 2024
 */
public class CalculatePhagenyxSystemAddOnCost extends CalculateTechnologyAddOnCost {

  private static final String TECHNOLOGY_NAME = "PHAGENYXSYSTEM";
