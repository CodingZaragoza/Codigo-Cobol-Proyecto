...
/**
 * Applies add-on costs for Nuzyra if the technology was indicated in the claim.
 *
 * @since 2021
 */
public class CalculateNuzyraAddOnCost extends CalculateTechnologyAddOnCost {

  private static final String TECHNOLOGY_NAME = "NUZYRA";

  @Override
  public void calculate(IppsPricerContext calculationContext) {
    //     IF PROC-NUZYRA-FLAG = 'Y'
