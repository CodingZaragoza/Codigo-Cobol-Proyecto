...
import gov.cms.fiss.pricers.ipps.core.rules.calculate_payment.tech_addons.technology.nt2024.CalculateCanaryLeftAddOnCost;
import gov.cms.fiss.pricers.ipps.core.rules.calculate_payment.tech_addons.technology.nt2024.CalculateCanaryRightAddOnCost;
...
import gov.cms.fiss.pricers.ipps.core.rules.calculate_payment.tech_addons.technology.nt2024.CalculateHemolungAddOnCost2024;
...
public class Ipps2024RulePricer extends IppsRulePricer {
  ...
  public Ipps2024RulePricer(DataTables dataTables) {
                            ...
                            List.of(
                                ...
                                new AddNewTechnologyCosts(
                                    List.of(
                                        ...
                                        new CalculateCanaryLeftAddOnCost(),
                                        new CalculateCanaryRightAddOnCost(),
                                        ...
                                        new CalculateHemolungAddOnCost2024(),
  ...
  protected IppsPricerContext contextFor(IppsClaimPricingRequest input) {
    ...
    return new Ipps2024PricerContext(input, output, dataTables);
  }
}
