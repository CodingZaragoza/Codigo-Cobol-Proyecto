...
/**
 * Applies add-on costs for Balversa if the technology was indicated in the claim.
 *
 * @since 2020
 */
public class CalculateBalversaAddOnCost extends CalculateTechnologyAddOnCost {

  private static final String TECHNOLOGY_NAME = "BALVERSA";

  @Override
  public void calculate(IppsPricerContext calculationContext) {
    //     IF PROC-BALVERSA-FLAG = 'Y'
