...
/**
 * Applies add-on costs for TOPS System if the technology was indicated in the claim.
 *
 * @since 2024
 */
public class CalculateTopsSystemAddOnCost extends CalculateTechnologyAddOnCost {

  private static final String TECHNOLOGY_NAME = "TOPSSYSTEM";
