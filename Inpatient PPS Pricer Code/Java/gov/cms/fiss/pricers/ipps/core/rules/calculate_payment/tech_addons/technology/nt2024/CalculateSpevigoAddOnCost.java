...
/**
 * Applies add-on costs for SPEVIGO if the technology was indicated in the claim.
 *
 * @since 2024
 */
public class CalculateSpevigoAddOnCost extends CalculateTechnologyAddOnCost {

  private static final String TECHNOLOGY_NAME = "SPEVIGO";
