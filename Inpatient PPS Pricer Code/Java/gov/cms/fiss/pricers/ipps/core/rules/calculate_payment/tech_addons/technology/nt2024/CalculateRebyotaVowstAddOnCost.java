...
/**
 * Applies add-on costs for Rebyota Vowst if the technology was indicated in the claim.
 *
 * @since 2024
 */
public class CalculateRebyotaVowstAddOnCost extends CalculateTechnologyAddOnCost {

  private static final String TECHNOLOGY_NAME = "REBYOTAVOWST";
