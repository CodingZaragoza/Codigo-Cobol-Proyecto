...
/**
 * Applies add-on costs for Paradise Ultrasound if the technology was indicated in the claim.
 *
 * @since 2025
 */
public class CalculateParadiseUltrasoundAddOnCost extends CalculateTechnologyAddOnCost {

  private static final String TECHNOLOGY_NAME = "PARADISEULTRASOUND";
