...
/**
 * Applies add-on costs for Stelara if the technology was indicated in the claim.
 *
 * @since 2019
 */
public class CalculateStelaraAddOnCost extends CalculateTechnologyAddOnCost {

  private static final String TECHNOLOGY_NAME = "STELARA";

  @Override
  public void calculate(IppsPricerContext calculationContext) {
    //     IF PROC-STELARA-FLAG = 'Y'
