...
/**
 * Applies add-on costs for Tecvayli if the technology was indicated in the claim.
 *
 * @since 2024
 */
public class CalculateTecvayliAddOnCost extends CalculateTechnologyAddOnCost {

  private static final String TECHNOLOGY_NAME = "TECVAYLI";
