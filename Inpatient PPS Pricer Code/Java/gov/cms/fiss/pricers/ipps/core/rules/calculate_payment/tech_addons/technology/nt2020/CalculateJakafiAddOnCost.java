...
/**
 * Applies add-on costs for Jakafi if the technology was indicated in the claim.
 *
 * @since 2020
 */
public class CalculateJakafiAddOnCost extends CalculateTechnologyAddOnCost {

  private static final String TECHNOLOGY_NAME = "JAKAFI";

  @Override
  public void calculate(IppsPricerContext calculationContext) {
    //     IF PROC-JAKAFI-FLAG = 'Y'
