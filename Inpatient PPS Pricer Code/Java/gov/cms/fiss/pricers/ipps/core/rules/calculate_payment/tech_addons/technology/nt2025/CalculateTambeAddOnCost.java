...
/**
 * Applies add-on costs for GORE EXCLUDER / TAMBE if the technology was indicated in the claim.
 *
 * @since 2025
 */
public class CalculateTambeAddOnCost extends CalculateTechnologyAddOnCost {

  private static final String TECHNOLOGY_NAME = "TAMBE";
