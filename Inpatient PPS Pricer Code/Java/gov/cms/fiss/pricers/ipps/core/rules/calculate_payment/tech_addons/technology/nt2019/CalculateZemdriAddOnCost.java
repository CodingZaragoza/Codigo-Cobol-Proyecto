...
/**
 * Applies add-on costs for Zemdri if the technology was indicated in the claim.
 *
 * @since 2019
 */
public class CalculateZemdriAddOnCost extends CalculateTechnologyAddOnCost {

  private static final String TECHNOLOGY_NAME = "ZEMDRI";

  @Override
  public void calculate(IppsPricerContext calculationContext) {
    //     IF PROC-PLAZO-FLAG = 'Y'
