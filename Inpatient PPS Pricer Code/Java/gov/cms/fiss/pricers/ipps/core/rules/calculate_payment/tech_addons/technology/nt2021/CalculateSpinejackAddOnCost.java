...
/**
 * Applies add-on costs for Spinejack if the technology was indicated in the claim.
 *
 * @since 2021
 */
public class CalculateSpinejackAddOnCost extends CalculateTechnologyAddOnCost {

  private static final String TECHNOLOGY_NAME = "SPINEJACK";

  @Override
  public void calculate(IppsPricerContext calculationContext) {
    //     IF PROC-SPINEJACK-FLAG = 'Y'
