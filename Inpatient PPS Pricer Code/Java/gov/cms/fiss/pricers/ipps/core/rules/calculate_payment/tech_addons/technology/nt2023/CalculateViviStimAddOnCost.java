...
/**
 * Applies add-on costs for ViviStim if the technology was indicated in the claim.
 *
 * @since 2023
 */
public class CalculateViviStimAddOnCost extends CalculateTechnologyAddOnCost {

  private static final String TECHNOLOGY_NAME = "VIVISTIM";
