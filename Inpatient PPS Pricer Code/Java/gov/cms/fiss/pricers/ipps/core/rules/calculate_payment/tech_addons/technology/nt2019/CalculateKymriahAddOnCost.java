...
/**
 * Applies add-on costs for Kymriah if the technology was indicated in the claim.
 *
 * @since 2019
 */
public class CalculateKymriahAddOnCost extends CalculateTechnologyAddOnCost {

  private static final String TECHNOLOGY_NAME = "KYMRIAH";

  @Override
  public void calculate(IppsPricerContext calculationContext) {
    //     IF PROC-KYMRIAH-FLAG = 'Y'
