 ...
 * @since 2021
 */
public class CalculateFetrojaAddOnCost2022 extends CalculateTechnologyAddOnCost {
  ...
  public void calculate(IppsPricerContext calculationContext) {
    ...
    if (dataTables.codesMatch(
        "FETROJA1", ClaimCodeType.PROC, calculationContext.getClaimData().getProcedureCodes())) {
      if (dataTables.codesMatch(
                  "FETROJA2",
                  ClaimCodeType.DIAG,
          ...
          || dataTables.codesMatch(
              ...
              && dataTables.codesMatch(
                  ...
                  ClaimCodeType.DIAG,
                  calculationContext.getClaimData().getDiagnosisCodes())) {
        aggregateNewTechCost(calculationContext, dataTables.getNewTechnologyAmount("FETROJAH"));
      } else {
        aggregateNewTechCost(calculationContext, dataTables.getNewTechnologyAmount("FETROJAL"));
      }
    }
  }
}
