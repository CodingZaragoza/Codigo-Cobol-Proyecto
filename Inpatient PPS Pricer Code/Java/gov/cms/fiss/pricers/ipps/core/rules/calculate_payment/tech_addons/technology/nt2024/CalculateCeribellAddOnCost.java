...
/**
 * Applies add-on costs for Ceribell if the technology was indicated in the claim.
 *
 * @since 2024
 */
public class CalculateCeribellAddOnCost extends CalculateTechnologyAddOnCost {

  private static final String TECHNOLOGY_NAME = "CERIBELL";
