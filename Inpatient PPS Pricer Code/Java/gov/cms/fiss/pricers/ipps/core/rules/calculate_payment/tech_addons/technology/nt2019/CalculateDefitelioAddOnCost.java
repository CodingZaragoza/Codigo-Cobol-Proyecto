...
/**
 * Applies add-on costs for Defitelio if the technology was indicated in the claim.
 *
 * @since 2019
 */
public class CalculateDefitelioAddOnCost extends CalculateTechnologyAddOnCost {

  private static final String TECHNOLOGY_NAME = "DEFITELIO";

  @Override
  public void calculate(IppsPricerContext calculationContext) {
    //     IF PROC-DEFITELIO-FLAG = 'Y'
