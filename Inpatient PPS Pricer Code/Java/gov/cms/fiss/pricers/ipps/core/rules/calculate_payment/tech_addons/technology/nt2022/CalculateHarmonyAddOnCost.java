...
/**
 * Applies add-on costs for Harmony if the technology was indicated in the claim.
 *
 * @since 2022
 */
public class CalculateHarmonyAddOnCost extends CalculateTechnologyAddOnCost {

  private static final String TECHNOLOGY_NAME = "HARMONY";
