...
/**
 * Applies add-on costs for T2Bacteria if the technology was indicated in the claim.
 *
 * @since 2020
 */
public class CalculateT2BacteriaAddOnCost extends CalculateTechnologyAddOnCost {

  private static final String TECHNOLOGY_NAME = "T2BACTERIA";
