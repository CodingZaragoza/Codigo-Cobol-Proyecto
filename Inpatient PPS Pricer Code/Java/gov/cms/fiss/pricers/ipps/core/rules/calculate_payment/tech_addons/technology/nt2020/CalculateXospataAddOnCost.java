...
/**
 * Applies add-on costs for Xospata if the technology was indicated in the claim.
 *
 * @since 2020
 */
public class CalculateXospataAddOnCost extends CalculateTechnologyAddOnCost {

  private static final String TECHNOLOGY_NAME = "XOSPATA";
