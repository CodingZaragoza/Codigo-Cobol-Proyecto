...
/**
 * Applies add-on costs for Darzalex if the technology was indicated in the claim.
 *
 * @since 2023
 */
public class CalculateDarzalexAddOnCost extends CalculateTechnologyAddOnCost {

  private static final String TECHNOLOGY_NAME = "DARZALEX";
