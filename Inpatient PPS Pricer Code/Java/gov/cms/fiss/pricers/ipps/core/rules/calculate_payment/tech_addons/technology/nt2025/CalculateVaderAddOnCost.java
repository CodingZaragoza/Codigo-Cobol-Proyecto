...
/**
 * Applies add-on costs for VADER if the technology was indicated in the claim.
 *
 * @since 2025
 */
public class CalculateVaderAddOnCost extends CalculateTechnologyAddOnCost {

  private static final String TECHNOLOGY_NAME = "VADER";
