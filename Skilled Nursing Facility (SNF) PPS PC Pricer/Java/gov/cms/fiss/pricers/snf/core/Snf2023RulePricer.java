...
/** 2023 implementation of the SNF pricer. */
public class Snf2023RulePricer extends SnfRulePricer {

  public Snf2023RulePricer(DataTables dataTables) {
  ...
  protected SnfPricerContext contextFor(SnfClaimPricingRequest input) {
    return new Snf2023PricerContext(input, new SnfClaimPricingResponse(), dataTables);
  }
}
