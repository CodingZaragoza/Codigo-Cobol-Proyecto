...
public class Snf2024RulePricer extends SnfRulePricer {

  public Snf2024RulePricer(DataTables dataTables) {
  ...
  protected SnfPricerContext contextFor(SnfClaimPricingRequest input) {
    return new Snf2024PricerContext(input, new SnfClaimPricingResponse(), dataTables);
  }
}
