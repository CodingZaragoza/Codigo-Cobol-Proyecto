...
import gov.cms.fiss.pricers.snf.core.rules.ApplySupplementalWageIndex;
...
/** 2024 implementation of the SNF pricer. */
public class Snf2025RulePricer extends SnfRulePricer {

  public Snf2025RulePricer(DataTables dataTables) {
  ...
  protected SnfPricerContext contextFor(SnfClaimPricingRequest input) {
    return new Snf2025PricerContext(input, new SnfClaimPricingResponse(), dataTables);
  }
}
