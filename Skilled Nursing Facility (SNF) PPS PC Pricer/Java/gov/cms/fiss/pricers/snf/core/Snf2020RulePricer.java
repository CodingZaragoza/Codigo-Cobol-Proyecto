...
/** 2020 implementation of the SNF pricer. */
public class Snf2020RulePricer extends SnfRulePricer {

  public Snf2020RulePricer(DataTables dataTables) {
  ...
  protected SnfPricerContext contextFor(SnfClaimPricingRequest input) {
    return new Snf2020PricerContext(input, new SnfClaimPricingResponse(), dataTables);
  }
}
