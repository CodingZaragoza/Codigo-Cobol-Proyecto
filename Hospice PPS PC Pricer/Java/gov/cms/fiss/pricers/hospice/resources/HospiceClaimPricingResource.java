...
public class HospiceClaimPricingResource {

  private final HospicePricerDispatch dispatch;

  public HospiceClaimPricingResource(HospicePricerDispatch dispatch) {
  ...
  @Timed
  @Operation(
      summary = "Prices a Hospice claim.",
      description =
          "Generates the pricing result for a Hospice Claim. The result includes payment data, as "
        ...
        @ApiResponse(
            ...
            content =
                @Content(
                    ...
                    schema = @Schema(implementation = HospiceClaimPricingResponse.class))),
        @ApiResponse(
            responseCode = "400",
            description =
  ...
  public HospiceClaimPricingResponse priceClaim(
      @NotNull
          @Valid
          @Parameter(
              ...
              name = "pricingRequest",
              required = true,
              schema = @Schema(implementation = HospiceClaimPricingRequest.class))
          HospiceClaimPricingRequest pricingRequest)
