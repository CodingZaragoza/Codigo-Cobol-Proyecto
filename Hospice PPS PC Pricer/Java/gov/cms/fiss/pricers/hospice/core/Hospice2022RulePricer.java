...
public class Hospice2022RulePricer extends HospiceRulePricer {
  private static final List<
          CalculationRule<
              HospiceClaimPricingRequest, HospiceClaimPricingResponse, HospicePricerContext>>
      RULES = rules();

  public Hospice2022RulePricer(DataTables dataTables) {
  ...
  protected HospicePricerContext contextFor(HospiceClaimPricingRequest input) {
    ...
    return new Hospice2022PricerContext(input, hospiceOutput, dataTables);
  }
