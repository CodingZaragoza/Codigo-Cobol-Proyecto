...
public class Hospice2021RulePricer extends HospiceRulePricer {
  ...
  public Hospice2021RulePricer(DataTables dataTables) {
  ...
  protected HospicePricerContext contextFor(HospiceClaimPricingRequest input) {
    ...
    return new Hospice2021PricerContext(input, hospiceOutput, dataTables);
  }
}
