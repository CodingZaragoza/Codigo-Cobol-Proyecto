...
public class Hospice2024RulePricer extends HospiceRulePricer {
  private static final List<
          CalculationRule<
              HospiceClaimPricingRequest, HospiceClaimPricingResponse, HospicePricerContext>>
      RULES = rules();

  public Hospice2024RulePricer(DataTables dataTables) {
  ...
  protected HospicePricerContext contextFor(HospiceClaimPricingRequest input) {
    ...
    return new Hospice2024PricerContext(input, hospiceOutput, dataTables);
  }
