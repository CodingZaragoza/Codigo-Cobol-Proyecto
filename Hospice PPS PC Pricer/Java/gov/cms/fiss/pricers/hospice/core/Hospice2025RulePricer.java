...
public class Hospice2025RulePricer extends HospiceRulePricer {
  private static final List<
          CalculationRule<
              HospiceClaimPricingRequest, HospiceClaimPricingResponse, HospicePricerContext>>
      RULES = rules();

  public Hospice2025RulePricer(DataTables dataTables) {
  ...
  protected HospicePricerContext contextFor(HospiceClaimPricingRequest input) {
    ...
    return new Hospice2025PricerContext(input, hospiceOutput, dataTables);
  }
