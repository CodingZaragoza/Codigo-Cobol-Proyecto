...
public class Hospice2023RulePricer extends HospiceRulePricer {
  private static final List<
          CalculationRule<
              HospiceClaimPricingRequest, HospiceClaimPricingResponse, HospicePricerContext>>
      RULES = rules();

  public Hospice2023RulePricer(DataTables dataTables) {
  ...
  protected HospicePricerContext contextFor(HospiceClaimPricingRequest input) {
    ...
    return new Hospice2023PricerContext(input, hospiceOutput, dataTables);
  }
