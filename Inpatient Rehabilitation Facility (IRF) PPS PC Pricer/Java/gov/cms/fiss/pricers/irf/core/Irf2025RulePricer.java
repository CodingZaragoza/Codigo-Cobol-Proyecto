...
import gov.cms.fiss.pricers.irf.core.rules.rules2025.Irf2025ApplySupplementalWageIndex;
import gov.cms.fiss.pricers.irf.core.rules.rules2025.Irf2025DetermineRuralAdjustment;
import gov.cms.fiss.pricers.irf.core.tables.DataTables;
import java.util.Arrays;
import java.util.List;

public class Irf2025RulePricer extends IrfRulePricer {

  public Irf2025RulePricer(DataTables dataTables) {
  ...
  protected IrfPricerContext contextFor(IrfClaimPricingRequest input) {
    ...
    return new Irf2025PricerContext(input, output, dataTables);
  }
  ...
  private static List<
    ...
    return Arrays.asList(
        ...
        new Irf2025ApplySupplementalWageIndex(),
        ...
        new PaymentCalculation(
            List.of(
                ...
                new Irf2025DetermineRuralAdjustment(),
