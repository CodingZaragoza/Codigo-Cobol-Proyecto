...
public class Irf2019RulePricer extends IrfRulePricer {

  public Irf2019RulePricer(DataTables dataTables) {
  ...
  protected IrfPricerContext contextFor(IrfClaimPricingRequest input) {
    return new Irf2019PricerContext(input, new IrfClaimPricingResponse(), dataTables);
  }
}
