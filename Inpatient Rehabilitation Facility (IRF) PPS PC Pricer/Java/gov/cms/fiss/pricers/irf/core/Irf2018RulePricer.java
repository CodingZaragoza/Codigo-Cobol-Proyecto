...
public class Irf2018RulePricer extends IrfRulePricer {

  public Irf2018RulePricer(DataTables dataTables) {
  ...
  protected IrfPricerContext contextFor(IrfClaimPricingRequest input) {
    return new Irf2018PricerContext(input, new IrfClaimPricingResponse(), dataTables);
  }
}
