...
public class Irf2021RulePricer extends IrfRulePricer {

  public Irf2021RulePricer(DataTables dataTables) {
  ...
  protected IrfPricerContext contextFor(IrfClaimPricingRequest input) {
    return new Irf2021PricerContext(input, new IrfClaimPricingResponse(), dataTables);
  }
}
