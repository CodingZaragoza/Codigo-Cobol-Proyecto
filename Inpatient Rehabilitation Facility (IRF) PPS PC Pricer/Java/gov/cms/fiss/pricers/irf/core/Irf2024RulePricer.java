...
public class Irf2024RulePricer extends IrfRulePricer {

  public Irf2024RulePricer(DataTables dataTables) {
  ...
  protected IrfPricerContext contextFor(IrfClaimPricingRequest input) {
    ...
    return new Irf2024PricerContext(input, output, dataTables);
  }
