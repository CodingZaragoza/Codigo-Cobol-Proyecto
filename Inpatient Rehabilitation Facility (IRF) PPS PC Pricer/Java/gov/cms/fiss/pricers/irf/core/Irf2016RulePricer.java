...
public class Irf2016RulePricer extends IrfRulePricer {

  public Irf2016RulePricer(DataTables dataTables) {
  ...
  protected IrfPricerContext contextFor(IrfClaimPricingRequest input) {
    return new Irf2016PricerContext(input, new IrfClaimPricingResponse(), dataTables);
  }
}
