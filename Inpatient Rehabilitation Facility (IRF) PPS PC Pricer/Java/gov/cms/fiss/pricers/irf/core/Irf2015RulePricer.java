...
public class Irf2015RulePricer extends IrfRulePricer {

  public Irf2015RulePricer(DataTables dataTables) {
  ...
  protected IrfPricerContext contextFor(IrfClaimPricingRequest input) {
    return new Irf2015PricerContext(input, new IrfClaimPricingResponse(), dataTables);
  }
}
