...
public class Irf2020RulePricer extends IrfRulePricer {

  public Irf2020RulePricer(DataTables dataTables) {
  ...
  protected IrfPricerContext contextFor(IrfClaimPricingRequest input) {
    return new Irf2020PricerContext(input, new IrfClaimPricingResponse(), dataTables);
  }
}
