...
public class Irf2025ApplySupplementalWageIndex
  ...
  public boolean shouldExecute(IrfPricerContext calculationContext) {
    ...
    return calculationContext.matchesReturnCode(ResultCode.OK_00)
        && (StringUtils.equals(
            ...
            ||
            // Fy2025&26:rural to urban transitions (indicator=3) have same cap as indicator=1
            StringUtils.equals(
                calculationContext.getProviderData().getSupplementalWageIndexIndicator(), "3"));
  }
  ...
  public void calculate(IrfPricerContext calculationContext) {
    ...
    // Ensure presence of supplemental wage index value since indicator is a 1 or a 3
    if (BigDecimalUtils.isLessThanOrEqualToZero(providerData.getSupplementalWageIndex())) {
