...
public class Irf2022RulePricer extends IrfRulePricer {

  public Irf2022RulePricer(DataTables dataTables) {
  ...
  protected IrfPricerContext contextFor(IrfClaimPricingRequest input) {
    ...
    return new Irf2022PricerContext(input, output, dataTables);
  }
