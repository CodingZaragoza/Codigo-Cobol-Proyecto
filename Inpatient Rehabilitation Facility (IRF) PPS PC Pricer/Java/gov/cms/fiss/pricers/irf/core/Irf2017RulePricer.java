...
import gov.cms.fiss.pricers.irf.core.rules.CalculateStandardPayment;
...
import gov.cms.fiss.pricers.irf.core.rules.DetermineRuralAdjustment;
...
import gov.cms.fiss.pricers.irf.core.rules.finalize_payment.CalculatePenaltyAmounts;
...
import gov.cms.fiss.pricers.irf.core.rules.finalize_payment.UpdateResultCode;
import gov.cms.fiss.pricers.irf.core.tables.DataTables;
import java.util.Arrays;
import java.util.List;

public class Irf2017RulePricer extends IrfRulePricer {

  public Irf2017RulePricer(DataTables dataTables) {
    ...
    return Arrays.asList(
        ...
        new DefaultPaymentFinalization(
            List.of(
                ...
                new CalculatePenaltyAmounts(),
                new CalculateTotalPayment(),
                new UpdateResultCode(),
  ...
  protected IrfPricerContext contextFor(IrfClaimPricingRequest input) {
    return new Irf2017PricerContext(input, new IrfClaimPricingResponse(), dataTables);
  }
}
