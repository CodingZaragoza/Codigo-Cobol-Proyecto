...
public class IrfClaimPricingResource {
  private final IrfPricerDispatch dispatch;

  public IrfClaimPricingResource(final IrfPricerDispatch dispatch) {
  ...
  @Timed
  @Operation(
      summary = "Prices an IRF claim.",
      description =
          "Generates the pricing result for an IRF Claim. The result includes payment data, as "
        ...
        @ApiResponse(
            ...
            content =
                @Content(
                    ...
                    schema = @Schema(implementation = IrfClaimPricingResponse.class))),
        @ApiResponse(
            responseCode = "400",
            description =
  ...
  public IrfClaimPricingResponse priceClaim(
      @NotNull
          @Valid
          @Parameter(
              ...
              name = "pricingRequest",
              required = true,
              schema = @Schema(implementation = IrfClaimPricingRequest.class))
          IrfClaimPricingRequest pricingRequest)
