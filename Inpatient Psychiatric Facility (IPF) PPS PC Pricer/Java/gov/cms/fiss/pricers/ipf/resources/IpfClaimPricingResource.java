...
public class IpfClaimPricingResource {

  private final IpfPricerDispatch dispatch;

  public IpfClaimPricingResource(IpfPricerDispatch dispatch) {
  ...
  @Timed
  @Operation(
      summary = "Prices an IPF claim.",
      description =
          "Generates the pricing result for an IPF Claim. The result includes payment data, as "
        ...
        @ApiResponse(
            ...
            content =
                @Content(
                    ...
                    schema = @Schema(implementation = IpfClaimPricingResponse.class))),
        @ApiResponse(
            responseCode = "400",
            description =
  ...
  public IpfClaimPricingResponse priceClaim(
      @NotNull
          @Valid
          @Parameter(
              ...
              name = "pricingRequest",
              required = true,
              schema = @Schema(implementation = IpfClaimPricingRequest.class))
          IpfClaimPricingRequest pricingRequest)
