...
public class Ipf2022RulePricer extends IpfRulePricer {

  private static final List<
          CalculationRule<IpfClaimPricingRequest, IpfClaimPricingResponse, IpfPricerContext>>
      YEAR_RULES = rules();

  public Ipf2022RulePricer(DataTables dataTables) {
  ...
  protected IpfPricerContext contextFor(IpfClaimPricingRequest request) {
    ...
    return new Ipf2022PricerContext(request, response, dataTables);
  }
}
