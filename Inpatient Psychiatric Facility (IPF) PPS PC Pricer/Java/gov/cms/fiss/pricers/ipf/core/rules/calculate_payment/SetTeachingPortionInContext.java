...
/**
 * Set the teaching portion of the payment.
 *
 * <p>Converted from {@code 3000-CALC-PAYMENT} in the COBOL code.
 */
public class SetTeachingPortionInContext
  ...
  public void calculate(IpfPricerContext calculationContext) {
    //      MOVE IPF-FED-PAYMENT TO WK-TEACH-PORTION.
    calculationContext.setTeachingPortion(calculationContext.getFederalPayment());
  }
}
