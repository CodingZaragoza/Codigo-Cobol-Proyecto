...
public class Ipf2023RulePricer extends IpfRulePricer {

  private static final List<
          CalculationRule<IpfClaimPricingRequest, IpfClaimPricingResponse, IpfPricerContext>>
      YEAR_RULES = rules();

  public Ipf2023RulePricer(DataTables dataTables) {
  ...
  protected IpfPricerContext contextFor(IpfClaimPricingRequest request) {
    ...
    return new Ipf2023PricerContext(request, response, dataTables);
  }
}
