...
public class CbsaWageIndexEntry {
  ...
  public CbsaWageIndexEntryBuilder copyBuilder() {
    return new CbsaWageIndexEntryBuilder().cbsa(cbsa).effectiveDate(effectiveDate).geographicWageIndex(geographicWageIndex).imputedFloorWageIndex(imputedFloorWageIndex).name(name).reclassifiedWageIndex(reclassifiedWageIndex).ruralFloorWageIndex(ruralFloorWageIndex).size(size);
  }
