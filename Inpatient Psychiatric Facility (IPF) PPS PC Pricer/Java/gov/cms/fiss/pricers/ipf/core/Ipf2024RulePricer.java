...
public class Ipf2024RulePricer extends IpfRulePricer {

  private static final List<
          CalculationRule<IpfClaimPricingRequest, IpfClaimPricingResponse, IpfPricerContext>>
      YEAR_RULES = rules();

  public Ipf2024RulePricer(DataTables dataTables) {
  ...
  protected IpfPricerContext contextFor(IpfClaimPricingRequest request) {
    ...
    return new Ipf2024PricerContext(request, response, dataTables);
  }
}
