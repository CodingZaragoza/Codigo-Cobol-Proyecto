...
import gov.cms.fiss.pricers.ltch.core.rules.CalculateFacilityCosts;
...
public class Ltch2020RulePricer extends LtchRulePricer {

  private static final List<
          CalculationRule<LtchClaimPricingRequest, LtchClaimPricingResponse, LtchPricerContext>>
      RULES = rules();

  public Ltch2020RulePricer(DataTables dataTables) {
    ...
    return List.of(
        ...
        new SkipOnErrorCode(
            List.of(
                ...
                new LookupFloorCBSA())),
        new AssignFloorCBSA(),
        new SkipOnErrorCode(List.of(new AssemblePpsVariables(), new CalculateFacilityCosts())),
        ...
        // TODO: Comment 1.5yr out-of-date. Unclear if this needs done
        // new CalculateHighCostOutlier(
        // List.of(
        //  new CalculateHighCostOutlierNonBlend(),
        //  new CalculateHighCostOutlierBlend())
        // ),
        new CalculateHighCostOutlier(),
        new CalculateHighCostOutlierBlend(),
  ...
  protected LtchPricerContext contextFor(LtchClaimPricingRequest input) {
    ...
    return new Ltch2020PricerContext(input, output, dataTables);
  }
}
