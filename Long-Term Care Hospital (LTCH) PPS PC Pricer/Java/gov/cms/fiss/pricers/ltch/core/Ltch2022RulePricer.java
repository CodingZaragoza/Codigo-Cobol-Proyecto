...
import gov.cms.fiss.pricers.ltch.core.rules.rules2022.DetermineIppsWageIndex2022;
import gov.cms.fiss.pricers.ltch.core.tables.DataTables;
import java.util.List;

public class Ltch2022RulePricer extends LtchRulePricer {

  private static final List<
          CalculationRule<LtchClaimPricingRequest, LtchClaimPricingResponse, LtchPricerContext>>
      RULES = rules();

  public Ltch2022RulePricer(DataTables dataTables) {
  ...
  private static List<
    ...
    return List.of(
        ...
        new DetermineIppsWageIndex2022(),
        new SkipOnErrorCode(
            List.of(
                new EditInputData(),
                new EditDrgCode(),
  ...
  protected LtchPricerContext contextFor(LtchClaimPricingRequest input) {
    ...
    return new Ltch2022PricerContext(input, output, dataTables);
  }
}
