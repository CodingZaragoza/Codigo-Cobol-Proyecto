...
public class Ltch2024RulePricer extends LtchRulePricer {

  private static final List<
          CalculationRule<LtchClaimPricingRequest, LtchClaimPricingResponse, LtchPricerContext>>
      RULES = rules();

  public Ltch2024RulePricer(DataTables dataTables) {
  ...
  protected LtchPricerContext contextFor(LtchClaimPricingRequest input) {
    ...
    return new Ltch2024PricerContext(input, output, dataTables);
  }
}
