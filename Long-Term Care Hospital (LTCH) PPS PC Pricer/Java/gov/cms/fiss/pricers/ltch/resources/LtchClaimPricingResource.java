...
public class LtchClaimPricingResource {
  private final LtchPricerDispatch dispatch;

  public LtchClaimPricingResource(LtchPricerDispatch dispatch) {
  ...
  @Timed
  @Operation(
      summary = "Prices an LTCH claim.",
      description =
          "Generates the pricing result for an LTCH Claim. The result includes payment data, as "
        ...
        @ApiResponse(
            ...
            content =
                @Content(
                    ...
                    schema = @Schema(implementation = LtchClaimPricingResponse.class))),
        @ApiResponse(
            responseCode = "400",
            description =
  ...
  public LtchClaimPricingResponse priceClaim(
      @NotNull
          @Valid
          @Parameter(
              ...
              name = "pricingRequest",
              required = true,
              schema = @Schema(implementation = LtchClaimPricingRequest.class))
          LtchClaimPricingRequest pricingRequest)
