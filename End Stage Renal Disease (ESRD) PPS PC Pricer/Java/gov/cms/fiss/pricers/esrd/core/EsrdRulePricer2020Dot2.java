...
import gov.cms.fiss.pricers.esrd.core.rules.rules_2020_2.bundled_factors.transitional_payments.AdjustFinalPayment2020Dot2;
...
public class EsrdRulePricer2020Dot2 extends EsrdRulePricer {

  private static final List<
          CalculationRule<EsrdClaimPricingRequest, EsrdClaimPricingResponse, EsrdPricerContext>>
      RULES = rules();

  public EsrdRulePricer2020Dot2(DataTables dataTables) {
                            ...
                            List.of(
                                ...
                                new CalculateTransitionalPayments(
                                    List.of(
                                        ...
                                        new AdjustFinalPayment2020Dot2())),
                                ...
                                new SetReturnCode())))),
                new MoveResults(
                    List.of(new MoveBaseResults2020Dot2(), new MoveAdditionalDataResults())))));
  }

  @Override
  protected EsrdPricerContext contextFor(EsrdClaimPricingRequest input) {
    return new EsrdPricerContext2020Dot2(input, createDefaultResponse(), dataTables);
  }
}
