...
public class EsrdRulePricer2023 extends EsrdRulePricer {

  private static final List<
          CalculationRule<EsrdClaimPricingRequest, EsrdClaimPricingResponse, EsrdPricerContext>>
      RULES = rules();

  public EsrdRulePricer2023(DataTables dataTables) {
  ...
  protected EsrdPricerContext contextFor(EsrdClaimPricingRequest esrdClaimPricingRequest) {
    return new EsrdPricerContext2023(esrdClaimPricingRequest, createDefaultResponse(), dataTables);
  }
}
