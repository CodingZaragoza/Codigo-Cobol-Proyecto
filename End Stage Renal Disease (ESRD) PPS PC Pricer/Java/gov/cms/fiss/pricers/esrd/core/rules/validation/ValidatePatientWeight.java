...
/**
 * Performs patient weight validation.
 *
 * <p>Converted from {@code 1000-VALIDATE-BILL-ELEMENTS} in the COBOL code.
 *
 * @since 2020
 */
public class ValidatePatientWeight
  ...
  public void calculate(EsrdPricerContext calculationContext) {
    ...
    if (!calculationContext.isAki84() && BigDecimalUtils.isZero(claimData.getPatientWeight())) {
      calculationContext.applyReturnCode(ReturnCode.INVALID_PATIENT_WEIGHT_55);
    }
  }
}
