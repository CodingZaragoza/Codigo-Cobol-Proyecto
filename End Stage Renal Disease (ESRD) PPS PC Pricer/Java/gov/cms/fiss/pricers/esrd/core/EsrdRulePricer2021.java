...
import gov.cms.fiss.pricers.esrd.core.rules.rules_2021.bundled_factors.transitional_payments.AdjustFinalPayment2021;
...
import gov.cms.fiss.pricers.esrd.core.rules.rules_2021.wage_index.ApplySupplementalWageIndex2021;
...
public class EsrdRulePricer2021 extends EsrdRulePricer {

  private static final List<
          CalculationRule<EsrdClaimPricingRequest, EsrdClaimPricingResponse, EsrdPricerContext>>
      RULES = rules();

  public EsrdRulePricer2021(DataTables dataTables) {
            ...
            List.of(
                ...
                new ExtractWageIndex(
                    List.of(
                        ...
                        new ApplySupplementalWageIndex2021())),
                new BillValidation(
                    List.of(
                    ...
                    List.of(
                        new CalculateBundledFactors(
                            List.of(
                                ...
                                new CalculateBundledConditionCodePayment2020Dot2(),
                                ...
                                new SetReturnCode())))),
                new MoveResults(
                    List.of(new MoveBaseResults2021(), new MoveAdditionalDataResults())))));
  }

  @Override
  protected EsrdPricerContext contextFor(EsrdClaimPricingRequest input) {
    return new EsrdPricerContext2021(input, createDefaultResponse(), dataTables);
  }
}
