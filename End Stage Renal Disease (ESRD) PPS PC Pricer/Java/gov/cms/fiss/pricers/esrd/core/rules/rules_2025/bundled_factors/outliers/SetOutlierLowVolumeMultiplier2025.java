 ...
 * @since 2020
 */
public class SetOutlierLowVolumeMultiplier2025
      ...
      if (!calculationContext.isAdultPatient()) {
        ...
        if (calculationContext.isLowVolumeClaimTierOne()) {
          calculationContext.setOutlierLowVolumeMultiplier(
              calculationContext.getSeparatelyBillableLowVolumeAdjustmentLessThan3000Multiplier());
        }
        if (calculationContext.isLowVolumeClaimTierTwo()) {
          calculationContext.setOutlierLowVolumeMultiplier(
              calculationContext.getSeparatelyBillableLowVolumeAdjustment3000To3999Multiplier());
        }
