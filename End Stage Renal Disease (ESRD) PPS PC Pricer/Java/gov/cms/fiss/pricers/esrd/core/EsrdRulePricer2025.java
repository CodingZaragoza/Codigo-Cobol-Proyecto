...
import gov.cms.fiss.pricers.esrd.core.rules.rules_2025.CalculateAkiPayment2025;
...
import gov.cms.fiss.pricers.esrd.core.rules.rules_2025.CalculateBundledWageAdjustedRate2025;
import gov.cms.fiss.pricers.esrd.core.rules.rules_2025.CalculateBundledWageAdjustedRateAki2025;
...
import gov.cms.fiss.pricers.esrd.core.rules.rules_2025.MoveAdditionalDataResults2025;
...
import gov.cms.fiss.pricers.esrd.core.rules.rules_2025.bundled_factors.CalculateRuralAdjustmentMultiplier2025;
import gov.cms.fiss.pricers.esrd.core.rules.rules_2025.bundled_factors.low_volume.CalculateBundledLowVolumeAdjustment2025;
...
import gov.cms.fiss.pricers.esrd.core.rules.rules_2025.bundled_factors.outliers.AdjustPredictedOutlierSvcsMapPerTrtByPostTdapa2025;
...
import gov.cms.fiss.pricers.esrd.core.rules.rules_2025.bundled_factors.outliers.CalculateOutlierRuralAdjustmentMultiplier2025;
import gov.cms.fiss.pricers.esrd.core.rules.rules_2025.bundled_factors.outliers.CalculatePatientLevelCaseMixAdjusterForPostTdapa;
import gov.cms.fiss.pricers.esrd.core.rules.rules_2025.bundled_factors.outliers.SetOutlierLowVolumeMultiplier2025;
import gov.cms.fiss.pricers.esrd.core.rules.rules_2025.bundled_factors.transitional_payments.CalculatePostTdapaAddOn2025;
import gov.cms.fiss.pricers.esrd.core.rules.rules_2025.wage_index.ApplySpecialWageIndex2025;
import gov.cms.fiss.pricers.esrd.core.rules.rules_2025.wage_index.ApplySupplementalWageIndex2025;
...
import gov.cms.fiss.pricers.esrd.core.rules.validation.ValidateSpecialLocalityIndicator;
...
public class EsrdRulePricer2025 extends EsrdRulePricer {

  private static final List<
          CalculationRule<EsrdClaimPricingRequest, EsrdClaimPricingResponse, EsrdPricerContext>>
      RULES = rules();

  public EsrdRulePricer2025(DataTables dataTables) {
        ...
        new ProcessClaim(
            List.of(
                ...
                new ExtractWageIndex(
                    List.of(
                        new ApplySpecialWageIndex2025(),
                        new RetrieveCbsaWageIndex(),
                        new ApplySupplementalWageIndex2025())),
                new BillValidation(
                    List.of(
                        ...
                        new ValidateSpecialLocalityIndicator())),
                new CalculateBundledWageAdjustedRate2025(),
                new CalculateBundledWageAdjustedRateAki2025(),
                new CalculateAkiPayment2025(),
                    ...
                    List.of(
                        new CalculateBundledFactors(
                            List.of(
                                ...
                                new CalculateBundledLowVolumeAdjustment2025(),
                                new CalculateRuralAdjustmentMultiplier2025(),
                                ...
                                new CalculateTransitionalPayments(
                                    List.of(
                                        ...
                                        new CalculatePostTdapaAddOn2025(),
                                ...
                                new CalculateBundledOutliers(
                                    List.of(
                                        ...
                                        new SetOutlierLowVolumeMultiplier2025(),
                                        new CalculateOutlierRuralAdjustmentMultiplier2025(),
                                        new CalculatePredictedOutlierSvcsMapPerTrt(),
                                        new CalculateCaseMixAdjOutlierPredSvcsMapPerTrt(),
                                        new CalculatePatientLevelCaseMixAdjusterForPostTdapa(),
                                        new AdjustPredictedOutlierSvcsMapPerTrtByPostTdapa2025(),
                                ...
                                new SetReturnCode())))),
                new MoveResults(
                    List.of(new MoveBaseResults2025(), new MoveAdditionalDataResults2025())))));
  }

  @Override
  protected EsrdPricerContext contextFor(EsrdClaimPricingRequest esrdClaimPricingRequest) {
    return new EsrdPricerContext2025(esrdClaimPricingRequest, createDefaultResponse(), dataTables);
  }
}
