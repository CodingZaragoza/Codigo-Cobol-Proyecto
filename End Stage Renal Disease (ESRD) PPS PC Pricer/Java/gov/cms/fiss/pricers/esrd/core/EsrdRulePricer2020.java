...
import gov.cms.fiss.pricers.esrd.core.rules.bundled_factors.CalculateBundledPpsFinalPaymentRate;
...
import gov.cms.fiss.pricers.esrd.core.rules.bundled_factors.transitional_payments.AdjustFinalPayment;
...
public class EsrdRulePricer2020 extends EsrdRulePricer {

  private static final List<
          CalculationRule<EsrdClaimPricingRequest, EsrdClaimPricingResponse, EsrdPricerContext>>
      RULES = rules();

  public EsrdRulePricer2020(DataTables dataTables) {
                    ...
                    List.of(
                        new CalculateBundledFactors(
                            List.of(
                                ...
                                new CalculateBundledConditionCodePayment(),
                                new CalculateBundledPpsFinalPaymentRate(),
                                new CalculateTransitionalPayments(
                                    List.of(new CalculateTdapaPayment(), new AdjustFinalPayment())),
                                ...
                                new SetReturnCode())))),
                new MoveResults(List.of(new MoveBaseResults(), new MoveAdditionalDataResults())))));
  }

  @Override
  protected EsrdPricerContext contextFor(EsrdClaimPricingRequest input) {
    return new EsrdPricerContext2020(input, createDefaultResponse(), dataTables);
  }
}
