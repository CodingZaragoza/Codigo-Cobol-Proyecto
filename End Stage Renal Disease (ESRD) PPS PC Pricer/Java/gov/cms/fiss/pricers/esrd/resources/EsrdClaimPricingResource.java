package gov.cms.fiss.pricers.esrd.resources;
...
public class EsrdClaimPricingResource {
  private final EsrdPricerDispatch dispatch;

  public EsrdClaimPricingResource(EsrdPricerDispatch dispatch) {
  ...
  @Timed
  @Operation(
      summary = "Prices an ESRD claim.",
      description =
          "Generates the pricing result for an ESRD Claim. The result includes payment data, as "
        ...
        @ApiResponse(
            ...
            content =
                @Content(
                    ...
                    schema = @Schema(implementation = EsrdClaimPricingResponse.class))),
        @ApiResponse(
            responseCode = "400",
            description =
  ...
  public EsrdClaimPricingResponse priceClaim(
      @NotNull
          @Valid
          @Parameter(
              ...
              name = "pricingRequest",
              required = true,
              schema = @Schema(implementation = EsrdClaimPricingRequest.class))
          EsrdClaimPricingRequest pricingRequest)
