...
public class PerformApcAdjustments2025 extends AbstractLineCalculationRule {
  ...
  protected boolean isEligibleForAPCReduction(
    ...
    return !OppsPricerContext.isSection603(ioceServiceLine.getPaymentMethodFlag())
        ...
        // Exclude status indicator 'H1' & 'K1' from quality reduction
        && !StatusIndicator.H1_NON_OPIOID_MEDICAL_DEVICE.is(ioceServiceLine.getStatusIndicator())
        && !StatusIndicator.K1_NON_OPIOID_DRUG.is(ioceServiceLine.getStatusIndicator())
