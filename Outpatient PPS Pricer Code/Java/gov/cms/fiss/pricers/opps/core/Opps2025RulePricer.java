...
import gov.cms.fiss.pricers.opps.core.rules.calculate_deductible_lines.calculate_standard_payment.AdjustMinimumCoinsurance2025;
import gov.cms.fiss.pricers.opps.core.rules.calculate_deductible_lines.calculate_standard_payment.CalculateDeviceCredit;
import gov.cms.fiss.pricers.opps.core.rules.calculate_deductible_lines.calculate_standard_payment.CalculateLineReimbursement2025;
...
import gov.cms.fiss.pricers.opps.core.rules.calculate_deductible_lines.calculate_standard_payment.calculate_status_indicator_payments.PassThroughDeviceCategories2025;
...
import gov.cms.fiss.pricers.opps.core.rules.initialize_and_validate_lines.PerformApcAdjustments2025;
...
import gov.cms.fiss.pricers.opps.core.rules.initialize_and_validate_lines.ValidateIoceInputFlags2025;
...
/** 2025 implementation of the OPPS pricer. */
public class Opps2025RulePricer extends OppsRulePricer {

  public Opps2025RulePricer(DataTables dataTables) {
                    ...
                    List.of(
                        ...
                        new CalculateStatusIndicatorPayments(
                            List.of(
                                ...
                                new PassThroughDeviceCategories2025())),
                        new CalculateLineReimbursement2025(),
                        new AdjustMinimumCoinsurance2025(),
  ...
  protected OppsPricerContext contextFor(OppsClaimPricingRequest input) {
    ...
    return new Opps2025PricerContext(input, output, dataTables);
  }
}
