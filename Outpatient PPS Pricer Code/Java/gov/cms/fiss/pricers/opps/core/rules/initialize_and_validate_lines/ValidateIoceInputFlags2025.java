...
public class ValidateIoceInputFlags2025 extends AbstractLineCalculationRule {
  ...
  // Add Status Indicator 'H1' and 'K1' to valid SI list for CY2025
  ...
  // Add si = 'H1' to list for 2025 and forward
